...
const Oracoes = () => {
  ...
  // Fetch prayers
  const { data: prayers = [], isLoading: loadingPrayers } = useQuery({
    queryKey: ["prayers"],
    queryFn: async () => {
  ...
  const toggleFavoriteMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["user-favorite-prayers", user?.id] });
    },
    onError: (error: Error) => {
    ...
    <div className="min-h-screen bg-black relative">
      ...
      <div className="container mx-auto px-4 pt-16 pb-32">
          ...
          <div className="flex flex-col items-center w-full max-w-3xl">
            ...
            <div className="flex justify-center w-full mb-6">
              <GlassCard className="w-full max-w-[500px] p-0 overflow-hidden">
                <video
                  src="https://fnksvazibtekphseknob.supabase.co/storage/v1/object/public/criativos/oracoes.mp4"
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {loadingPrayers || loadingFavorites ? (
            ...
            <GlassCard className="text-center py-12">
              ...
              <p className="text-foreground/60">
                {showFavorites
                  ? "Você ainda não favoritou nenhuma oração"
