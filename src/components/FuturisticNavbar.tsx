...
export const FuturisticNavbar = () => {
  ...
  return (
    <nav className="navbar-glass fixed top-0 left-0 right-0 z-50 px-4 pb-2 pt-[max(0.5rem,env(safe-area-inset-top))]">
      <div className="flex justify-between items-center">
        <Link to="/">
          <img 
            src="https://fnksvazibtekphseknob.supabase.co/storage/v1/object/public/criativos/logonova2navbar.png"
            alt="BíbliaToon"
